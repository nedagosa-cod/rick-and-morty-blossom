...
function CardCharacterSkeleton() {
  return (
    <div className="flex flex-col flex-1 h-80">
      <h2 className="my-4 text-md text-stone-600">STARRED CHARACTERS (0)</h2>
      <h2 className="my-4 text-md text-stone-600">CHARACTERS (0)</h2>
      ...
      <div className="flex flex-col flex-1 gap-4">
        ...
        <div className="flex items-center space-x-4 ">
          <Skeleton className="w-12 h-12 rounded-full bg-primary/5" />
          <div className="space-y-2">
